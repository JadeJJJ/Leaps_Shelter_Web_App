    ...
    <style>
            ...
            font-weight: 420;
                ...
                <div style="background-color:black; width: 100%; height: 80px; border-radius:  10px 10px 0 0; text-align:center">
                    <asp:Label ID="Label2" runat="server" style="margin-left: 20px;  text-align: center" Font-Size="30pt" Font-Names="Century Gothic" ForeColor="Yellow" Text=" About Us"></asp:Label>
                </div>
                </div>

                <br />
                <div class="auto-style77">
                    <div class="auto-style78">
                    Who are we?</div><br />
                    LEAPS ( established 2008) is a registered, non-profit animal welfare organisation. We are dedicated to helping animals in need in the areas of Elands Bay, Lamberts Bay and Vredenburg up the West Coast, 220 km&nbsp;from Cape Town.<br />                
                    <br />
                    ...
                    <div class="auto-style78">
                     Rescue, rehabilitate and rehome unwanted and/or homeless animals.<br />
                    </div>
                    <br />
