<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Pages/Employee_Layout.Master" AutoEventWireup="true" CodeBehind="EmployeeHome.aspx.cs" Inherits="Leaps_Shelter_Web_App.Pages.EmployeeHome" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Button ID="Button1" runat="server" Text="Employee home" OnClick="Button1_Click" />
